                        ...
                        <View style={{ maxWidth: 600, flex: 1 }} >
                            <SafeAreaView style={styles.form}>
                                <View style={styles.container}>
                                    ...
                                    <Text variant="headlineSmall" style={{ alignSelf: 'center' }}>Cek email Anda!</Text>
                                    <Text variant="bodyMedium" style={{ marginTop: 10 , textAlign:'justify'}}>Kami telah mengirimkan instruksi reset password ke email <Text style={{ fontWeight: 'bold' }}>{email && email}</Text>. Silakan cek folder inbox maupun spam.</Text>
                                    ...
                                    <View style={{ alignItems: 'center' }}>
                                        <Text variant="bodyMedium" style={{ marginTop: 10 }}>Belum menerima email?</Text>
